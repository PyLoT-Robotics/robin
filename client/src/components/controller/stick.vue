<template>
  <div class="pt-3">
    <div class="relative size-20">
      ...
      >
        <div
          class="h-full w-full rounded-full border border-white border-dotted -translate-y-0.5"
        />
      </div>
      <div class="h-full w-full p-2">
        <div class="h-full w-full rounded-full border border-white border-dotted"></div>
      </div>
    </div>
  </div>
</template>
...
function onControl(clientX: number, clientY: number) {
  ...
  updatePosition(clientX - containerRect.left - offsetX, clientY - containerRect.top - offsetY)
